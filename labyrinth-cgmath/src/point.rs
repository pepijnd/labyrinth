...
pub type FloatPoint1 = Point1<f32>;
pub type FloatPoint2 = Point2<f32>;
pub type FloatPoint3 = Point3<f32>;

implement_uniform_block!(FloatPoint1, x);
implement_uniform_block!(FloatPoint2, x, y);
implement_uniform_block!(FloatPoint3, x, y, z);

impl glium::uniforms::AsUniformValue for FloatPoint3 {
