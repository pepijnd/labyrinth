...
pub type FloatMat2 = Matrix2<f32>;
pub type FloatMat3 = Matrix3<f32>;
pub type FloatMat4 = Matrix4<f32>;

implement_uniform_block!(FloatMat2, x, y);
implement_uniform_block!(FloatMat3, x, y, z);
implement_uniform_block!(FloatMat4, x, y, z, w);

impl glium::uniforms::AsUniformValue for FloatMat4 {
