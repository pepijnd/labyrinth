...
pub type FloatVec1 = Vector1<f32>;
pub type FloatVec2 = Vector2<f32>;
pub type FloatVec3 = Vector3<f32>;
pub type FloatVec4 = Vector4<f32>;

implement_uniform_block!(FloatVec1, x);
implement_uniform_block!(FloatVec2, x, y);
//implement_uniform_block!(FloatVec3, x, y, z);
implement_uniform_block!(FloatVec4, x, y, z, w);

use glium::uniforms::{LayoutMismatchError, UniformBlock, UniformType};

use glium::program::BlockLayout;

impl UniformBlock for FloatVec3 {
    fn matches(layout: &BlockLayout, base_offset: usize) -> Result<(), LayoutMismatchError> {
        if FloatVec3::build_layout(base_offset) != *layout {
            Err(LayoutMismatchError::LayoutMismatch {
                expected: FloatVec3::build_layout(base_offset),
...
impl glium::uniforms::AsUniformValue for FloatVec3 {
